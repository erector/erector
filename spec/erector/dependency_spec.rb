...
describe "external declarations" do
  ...
  class InterpolatedEnchilada < Erector::Widget
    external :sample, File.new("#{File.dirname(__FILE__)}/sample-file.txt"), :interpolate => true
  end
